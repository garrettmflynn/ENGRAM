"""Colorbar management for the Engram module."""
import logging
...
class EngramCbar(object):
    ...
    def __init__(self, camera):
        ...
        # ------------------- CBARBASE -------------------
        # ________ ENGRAM ________
        cbproj = CbarBase(**self.atlas.to_dict())
        self.cbobjs.add_object('engram', cbproj)
        obj = self.cbobjs._objs['engram']
        obj._fcn = self._fcn_link_engram
        obj._minmaxfcn = self._fcn_minmax_engram
